...
__all__ = ["plugin_config_path", "Preference",
           "GoodListImageConfig", "SaltConfig", "DeviceConfig", "PluginConfig", "PluginEnv"]
...
class DeviceConfig(BaseModel):
    ...
    USER_AGENT_PC: str = ("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7) "
    ...
    USER_AGENT_ANDROID: str = ("Mozilla/5.0 (Linux; Android 11; MI 8 SE Build/RQ3A.211001.001; wv) "
                               "AppleWebKit/537.36 (KHTML, like Gecko) "
                               "Version/4.0 Chrome/104.0.5112.97 Mobile Safari/537.36 miHoYoBBS/2.55.1")
